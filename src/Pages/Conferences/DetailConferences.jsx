        ...
        <div className="top border" style={{ display: 'flex' }}>
          ...
          <div className="col-md-8">
            ...
            <div className="d-flex justify-content-between">
              <span className='fw-semibold'>  <Link to='/conference-enrollment'><button type="button" className='btn btn-outline-primary justify-content-end' style={{ width: '150px' }}> Join Now:</button></Link></span><Link to={conferences.manuscriptsubmissionurl} download><button type='button' className='btn btn-outline-primary mb-4' >Conferences Broucher</button></Link>
            </div>
